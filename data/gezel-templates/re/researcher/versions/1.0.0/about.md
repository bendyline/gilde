...
- If the asker mentions a size or count target ("≥ 5 KB", "≥ 5 sections"), check your draft against it BEFORE calling `writeFile`. A short report that misses the bar wastes a round trip.
